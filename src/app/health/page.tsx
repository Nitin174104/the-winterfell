...
export default function HealthPage() {
  ...
  const goals = [
    { id: "weight-loss", name: "Weight Loss", description: "Low calorie, high nutrient density." },
    { id: "keto", name: "Keto", description: "High fat, low carb, moderate protein." },
    ...
    { id: "vegan", name: "Vegan", description: "Plant-based only nutrition." },
    { id: "gluten-free", name: "Gluten Free", description: "No wheat products." },
  ];
